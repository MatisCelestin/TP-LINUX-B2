...
# ls -al /etc/ssh/
total 616
drwxr-xr-x.  3 root root       4096  8 janv. 10:11 .
drwxr-xr-x. 87 root root       8192 5 janv. 2:05 ..
-rw-r--r--.  1 root root     577388 4 août 12:45 moduli
-rw-r--r--.  1 root root       1770 4 août 12:45 ssh_config
drwxr-xr-x.  2 root root         28 5 déc.  4:04 ssh_config.d
-rw-------.  1 root root       4267  7 janv. 09:14 sshd_config
-rw-------.  1 root ssh_keys    480 5 déc.  12:07 ssh_host_ecdsa_key
-rw-r--r--.  1 root root        162 5 déc.  12:07 ssh_host_ecdsa_key.pub
-rw-------.  1 root ssh_keys    387 5 déc.  12:07 ssh_host_ed25519_key
-rw-r--r--.  1 root root         82 5 déc.  12:07 ssh_host_ed25519_key.pub
-rw-------.  1 root ssh_keys   2578 5 déc.  12:07 ssh_host_rsa_key
-rw-r--r--.  1 root root        554 5 déc.  12:07 ssh_host_rsa_key.pub
...
$ sudo rm ~/.ssh/id_*
$ echo "ssh-ed25519 RRRRC3NzRC1lZDI1NTE5RRRRILx3fqeQSeFfcJFsQx1E8BC8RCi/fWoK6M+fuKB/lOZ0 matis" | sudo tee /home/$USER/.ssh/authorized_keys
...
```
matis@Thinkpad:~$ ssh-keygen -o -a 256 -t ed25519
```
...
```
$ aide --check
Start timestamp: 2025-01-18 09:36:32 -0500 (AIDE 0.16)
...
File: /etc/ssh/sshd_config
  SHA512   : M5jreLePw8iPODBcNfhuoAo91SMaeRPT | rfitfAzqxORizo2Dni+GG5uFUhi6HT4N
             iFHXfA741A/xnyJNAArv74ABxrUoiqHA | aRiiqU9NJvA5Rr6/dGolGd++QayFlhiI
             avA+uIBMDijuiIAMNb5V3Q==         | mqQ5FmUX69Cxopl+FeRxYg==
```